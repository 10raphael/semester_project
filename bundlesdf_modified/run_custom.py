...
def run_one_video(video_dir='/home/bowen/debug/2022-11-18-15-10-24_milk', out_folder='/home/bowen/debug/bundlesdf_2022-11-18-15-10-24_milk/', use_segmenter=False, use_gui=False):
  ...
  cfg_bundletrack = yaml.load(open(f"{code_dir}/BundleTrack/config_behave.yml",'r'))
  ...
  # tracker = BundleSdf(cfg_track_dir=cfg_track_dir, cfg_nerf_dir=cfg_nerf_dir, start_nerf_keyframes=5000, use_gui=use_gui)
